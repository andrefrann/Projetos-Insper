...
xyz = Buttons(SCREEN_WIDTH/2,SCREEN_HEIGHT/2,"Instructions.png","Instructions2.png","Start_playing")
...
close_instr_menu= Buttons(SCREEN_WIDTH/2, SCREEN_HEIGHT/2, "close.png", "close.png", "Sair_instrução")
...
Img_Instruções = pygame.image.load('Images/ball.png')
Instruções_rect = Img_Instruções.get_rect()
# Instruções_rect.topleft = [0,0]
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if close_instr_menu.verify_click(pygame.mouse.get_pos()) == "Sair_instrução":
                    ...
                    for botoes in button_group_menu:
                        botoes.image = botoes.original # vai dar errado
